...
%CVDEV_INTERNAL%\win32\NetCoverage\OpenCover\OpenCover.Console.exe -register:user -target:"bin\Debug\Test.exe" -output:"bin\Debug\CoverageReport\CoverageResult.xml" -filter:"+[AVLTree]*" -log:Error
